...
export async function POST(request: Request) {
  ...
  try {
    ...
    let logoDataUrl = "";
    try {
      const logoPath = path.join(process.cwd(), "public", "images", "devdisplay-logo.png");
    ...
    try {
      ...
      const documentHtml = `<!doctype html><html><head>
        ...
        <div class="header">
          <div class="brand">
            ${logoDataUrl ? `<img src="${logoDataUrl}" alt="DevDisplay" />` : `<strong>DevDisplay</strong>`}
          </div>
          <div class="badge">devdisplay.org</div>
        </div>
        <div class="cover">
      ...
      return new Response(body, {
        ...
        headers: {
          ...
          "Content-Disposition": "attachment; filename=DevDisplay-Website-Audit.pdf",
